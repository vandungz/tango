...
import { CellValue, Clue, BoardSize, Board } from '@/engine/types';
...
export function GameProvider({ children }: { children: React.ReactNode }) {
    ...
    }, [cancelPendingHint, journeySummary.nextLevel, journeySummary.totalLevels, restartValidationDelay]);
